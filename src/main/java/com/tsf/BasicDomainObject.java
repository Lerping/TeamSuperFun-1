...
class BasicDomainObject {
     ...
     *
     * @GeneratedValue Java Persistence API Defines the ID generation strategy. If
     * the attribute is not used the application is responsible for key generation
     */
    private @Id @GeneratedValue Long id;

    /*
     * Attributes of the domain object General data used the in bussiness logic of
     * the application
     */
    private String data;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, BasicDomainObject.id) && Objects.equals(this.data, BasicDomainObject.data);
    }
